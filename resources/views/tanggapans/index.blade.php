                    ...
                    <div class="rounded-3xl bg-white p-6 shadow-xl hover:shadow-2xl transition transform hover:-translate-y-1 border border-slate-200">
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <div class="flex flex-col items-end gap-2">
                                <a href="{{ route('tanggapans.show', $tanggapan) }}" class="rounded-2xl bg-white px-4 py-2 text-sm font-semibold text-emerald-700 border border-emerald-100 hover:bg-emerald-50 transition">Detail</a>
                            </div>
                        </div>
                    </div>
                @empty
